...
out_imp = get_imputed_data(z=z,list_get_obs = out_obs, list_get_complete = out_comp, methods_list = methods_list, data_conditions = data_conditions, pctmiss_vec = pctmiss_vec, rep = 1, p = 1, save_it = TRUE, temp_wd_p = temp_wd_p_vec[p])