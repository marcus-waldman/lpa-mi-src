...
#' @param DMAT (matrix) Optional. A supplied K-by-K distance matrix. If not supplied, then one is calculated using the KL-Divergences.
...
resolve_label_switch<-function(mu_est_mat, S_est_array, z, data_conditions,
                               parameters_df = NULL, DMAT = NULL, name = "glpk", t_max = 30, approximate = 0, round_cplex = 0, trace_cplex = 0){
