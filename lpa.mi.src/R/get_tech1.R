...
get_tech1<-function(out_readModels){
      ...
      K_out = nrow(out_readModels$class_counts$modelEstimated)
      tech1_df = out_readModels$parameters$unstandardized[,c("paramHeader", "param", "LatentClass")] %>% transform(tech1 = NA)
